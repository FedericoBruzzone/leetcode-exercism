...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    return ((percentage >= 80 and 'green') or (percentage >= 60 and 'orange') or (percentage >= 30 and 'red') or 'black')
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    return ((criticality < low_threshold and 'LOW') or (criticality <= high_threshold and 'NORMAL') or 'DANGER')
